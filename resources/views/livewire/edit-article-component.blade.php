    ...
    <div class="space-y-10 divide-y divide-gray-900/10">
        <div class="gap-y-8">
            <div class="px-4 sm:px-0">
                <h2 class="text-base font-semibold leading-7 text-gray-900 p-4 pl-3 flex bg-gray-100">Edit: {{$this->article->title}}</h2>
            </div>

            <form wire:submit.prevent="update_article" method="POST" action="{{route('editArticle')}}" class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                    ...
                                    <input wire:model="title" type="text" name="title" id="title" value="{{old('title', $this->article->title)}}" required class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6">
                                    @error('title')
